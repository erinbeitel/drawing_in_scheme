...
def scheme_eval(expr, env, _=None): # Optional third argument is ignored
    ...
    """
    # Evaluate atoms
    # print("this is expr: {}".format(expr))
    ...
    if scheme_symbolp(first) and first in SPECIAL_FORMS:
        ...
        # print("procedure: {}".format(procedure))
...
class Procedure:
    ...
    def eval_call(self, operands, env):
        ...
        # BEGIN PROBLEM 5
        new_pair = operands.map(lambda operand: scheme_eval(operand, env))
        return scheme_apply(self, new_pair, env)
        # END PROBLEM 5
...
class PrimitiveProcedure(Procedure):
    ...
    def apply(self, args, env):
        ...
        try:
            return self.fn(*python_args) #review
        except TypeError:
            raise SchemeError('Oops! The wrong number of parameters were passed.')
...
class LambdaProcedure(UserDefinedProcedure):
    ...
    def make_call_frame(self, args, env):
        ...
        # print("self.formals: {}".format(self.formals))
        # print("self: {}".format(self))
        x = self.env.make_child_frame(self.formals, args)
        # print("x:{}".format(x))
        return x
        # END PROBLEM 12
...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(target):
        ...
        # BEGIN PROBLEM 6
        # value = eval_all(expressions.second.first, env)
...
def do_and_form(expressions, env):
    ...
    if expressions is nil:
        return True
    if isinstance(expressions.first, bool) and expressions.first == False:
        return False
...
def do_cond_form(expressions, env):
    ...
    # print("experssions: {}".format(expressions))
...
def do_let_form(expressions, env):
    ...
    # print("let_env now: {}".format(let_env))
    # print(expressions)
    # print(let_env.bindings)
...
def make_let_frame(bindings, env):
    ...
    # frame = Frame(env)
    # # if bindings is nil:
    # #     print("bindings is nil.")
    # #     print("frame now: {}".format(frame))
    # #     return frame
    # # else:
    # #     frame.define(bindings.first.first, bindings.first.second.first)
    # #     print("frame: {}".format(frame))
    # #     print("frame.bindings: {}".format(frame.bindings))

    # #     make_let_frame(bindings.second, env)
    # #     return frame
    # while bindings is not nil:
    #     # print("frame: {}".format(frame))
    #     # print("frame.bindings: {}".format(frame.bindings))
